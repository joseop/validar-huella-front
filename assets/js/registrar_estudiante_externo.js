...
document.getElementById('registrar_estudiantee').addEventListener('submit', async function(event) {
  ...
  try {
      const response = await fetch('http://localhost:8080/api/estudiante/externo', {
          method: 'POST',
          headers: {
